...
function SMTPPool(options) {
    ...
    this.options.rateLimitInterval = this.options.rateLimitInterval || 1000;
...
SMTPPool.prototype._checkRateLimit = function (callback) {
    ...
    if (this._rateLimit.checkpoint <= now - this.options.rateLimitInterval) {
        return this._clearRateLimit();
    } else if (!this._rateLimit.timeout) {
        this._rateLimit.timeout = setTimeout(this._clearRateLimit.bind(this), this.options.rateLimitInterval - (now - this._rateLimit.checkpoint));
